### 镜像下载脚本
当前使用python3.9以上的版本执行此脚本下载镜像

脚本内容如下：
```python3
#!/usr/bin/pyton3.10.12
#auth: Graves.Tan
...
proxies = {
    "http": "",
    "https": "",
    "no_proxy": "*.welink.huaweicloud.com;10.*;10.1.*;10.10.*;10.2.*;10.3.*;127.0.0.*;172.16.*;172.17.*;172.18.*;172.19.*;172.20.*;172.21.*;172.22.*;172.23.*;172.24.*;172.25.*;172.26.*;172.27.*;172.28.*;172.29.*;172.30.*;172.31.*;172.32.*",
}
...
repo = 'library'
tag = 'latest'
# sys.argv.append("docker.elastic.co/elasticsearch/elasticsearch:7.10.2")
